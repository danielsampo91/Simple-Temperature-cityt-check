...
class TrovaTemperatura(App):
    def build(self):
        ...
        self.etichetta = Label(text="Cerca una città...",
                                     font_size='20sp',
                                     color='007dd1')
    ...
    def trova_temp(self, instance):
        ...
        link = f"https://api.openweathermap.org/data/2.5/weather?q={self.input_testo.text}&appid=c54dde572481072e13476c096e836df9&units=metric"
        UrlRequest(link, edit_label)

# api c54dde572481072e13476c096e836df9
